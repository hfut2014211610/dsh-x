...
- **本目录现在只剩工装与文档。** 模型中心、每模型采样默认值、飞书通道都已进入正式 workspace——分别是 [`packages/llm/model-hub/`](../packages/llm/model-hub/README.zh.md)、[`packages/llm/model-tuning/`](../packages/llm/model-tuning/README.zh.md)、[`packages/channel/feishu/`](../packages/channel/feishu/README.zh.md)，设置页见 [`packages/client/ui-model-hub/`](../packages/client/ui-model-hub/README.zh.md) 与 [`packages/client/ui-settings-connectors/`](../packages/client/ui-settings-connectors/)。Web bundle 默认注册，安装包里就有——留在这里的话装完就没有，因为发行流程只打 `packages/*/*` 和 `apps/*`。
