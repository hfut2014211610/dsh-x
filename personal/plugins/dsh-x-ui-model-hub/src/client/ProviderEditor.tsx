      ...
      <div className={styles.form}>
        <section className={styles.group}>
          ...
          <label className={styles.field}>
            ...
            <select className={styles.select} value={presetKey} onChange={event => applyPreset(event.currentTarget.value)}>
        ...
        <section className={styles.group}>
          ...
          <div className={styles.fieldRow}>
            <label className={styles.field}>
              <span className={styles.label}>{t('providerKey')}</span>
              <Input
                value={key}
                onChange={(event) => { setKeyTouched(true); setKey(event.currentTarget.value) }}
                readOnly={editing !== null}
                placeholder="my-gateway"
              />
              <span className={styles.hint}>{t('keyHint')}</span>
            </label>
            <label className={styles.field}>
          ...
          <label className={styles.field}>
            ...
            <Input value={baseURL} onChange={event => setBaseURL(event.currentTarget.value)} placeholder="https://gateway.example/v1" />
          </label>
          <label className={styles.field}>
        ...
        <section className={styles.group}>
          ...
          <label className={styles.field}>
            ...
            <Input value={apiKeyEnv} onChange={event => setApiKeyEnv(event.currentTarget.value)} placeholder="GATEWAY_API_KEY" />
