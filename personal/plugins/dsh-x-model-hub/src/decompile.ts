 ...
 *
 * @module @personal/dsh-x-model-hub/decompile
 */
...
export function planImport(
  ...
  for (const [route, profile] of Object.entries(routes)) {
    ...
    for (const entry of profile.models) {
      ...
      if (entry.reasoningEfforts !== undefined) model.reasoningEfforts = entry.reasoningEfforts as NonNullable<HubModel['reasoningEfforts']>
