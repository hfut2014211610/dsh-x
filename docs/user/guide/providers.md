...
This guide assumes you started the Web UI through the [root README](../../../README.md#run-from-source). Model changes take effect on the next request without restarting the server.
