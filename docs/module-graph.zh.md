...
| [`documents-local`](../packages/writing/documents-local) | `writing` | [`documents`](../packages/writing/documents), [`fs`](../packages/fs/fs), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session) |
