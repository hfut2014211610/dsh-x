...
| [`werewolf`](../packages/game/werewolf) | `game` | [`brand`](../packages/util/brand), [`session`](../packages/core/session) |
...
| [`werewolf-classic`](../packages/game/werewolf-classic) | `game` | [`werewolf`](../packages/game/werewolf) |
