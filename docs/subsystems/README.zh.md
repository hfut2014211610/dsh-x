...
| [writing.md](writing.md) | 写作模式：文档能力词汇、`ctx.documents`、`documents/changed` 与 `writing` preset 表面 |
...
| [werewolf.md](werewolf.md) | 确定性狼人杀游戏核心：可信注册表之上的规则集编译、`werewolf/*` 事件族、纯函数阶段引擎与 Bot 连续性上下文 |
