/**
 * Epoch-aware promotion tracker shared by the bootstrap and context-gate
 * plugins of this preset.
 *
 ...
 * first-token conditions this preset exists to control. Promotion is
