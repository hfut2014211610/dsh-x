 ...
 *  - Files are probed via `ctx.get('fs')` (the host filesystem seam); a
 *    missing fs service or an unreadable probe degrades to no hint (never
 *    throws).
 ...
 *    first reply or tool call open its hint — which also keeps the injection
