...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'read\') read(request: { sessionId: SessionId path: string locator?: DocumentLocator }): Promise<DocumentReadResult>',
      ...
      {
        signature: '@Remote(\'outline\') outline(request: { sessionId: SessionId path: string }): Promise<DocumentOutlineResult>',
      ...
      {
        signature: '@Remote(\'search\') search(request: { sessionId: SessionId query: string limit?: number }): Promise<DocumentSearchResult>',
      ...
      {
        signature: '@Remote(\'create\') create(request: { sessionId: SessionId path: string content: string }): Promise<{ path: string; version: string }>',
      ...
      {
        signature: '@Remote(\'apply\') apply(request: { sessionId: SessionId path: string baseVersion: string edit: DocumentEdit }): Promise<{ version: string }>',
