...
| [`../client/ui-werewolf/`](../client/ui-werewolf/README.zh.md) | 独立游戏窗口 UI：入口、可恢复大厅、遮盖揭示、游戏桌、通用动作表单、观战、结算与授权复盘。 | `sidebar.footer.action` + `shell.surface` |

子系统参考见 [docs/subsystems/werewolf.md](../../docs/subsystems/werewolf.zh.md)；已交付的窗口、Host 与 Bot 所有权决策记录在[已实现特性笔记](../../.agents/notes/implemented/feature/2026-08-24-isolated-werewolf-application.zh.md)中。
