...
/** Required services: conversation slot and service, sessions, remote, locale. */
export const inject = ['slots', 'conversation', 'sessions', 'remote', 'locale']
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.slots.inject('conversation.view', () => ctx.slots.register({
    ...
    inject: (_sessionId: SessionId): WerewolfViewInjected => ({
      getLobby: async () => {
