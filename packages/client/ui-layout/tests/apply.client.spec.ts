...
describe('ui-layout client apply', () => {
  ...
  it('provides ctx.layout and registers AppFrame into root with the shell routing declaration', async () => {
    ...
    expect(slots.spec('shell.surface')).toEqual({ kind: 'chain', scope: 'session-maybe' })
