 ...
 * packages/llm/model-hub/src/compile.ts — keep in sync.
 */
...
/** Display and capacity fields shared by authored and preset models. */
...
export interface HubModel extends HubModelFallback, ModelCapabilities {
...
export interface PresetModel extends ModelCapabilities {
  id: string
  api: string
}
