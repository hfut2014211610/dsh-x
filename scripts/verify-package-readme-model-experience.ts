...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-model-hub': { kind: 'none', reason: 'Browser-side settings surface; registers no model surface.' },
  ...
  'packages/client/ui-settings-usage': { kind: 'none', reason: 'Browser-side usage panel over wire-delivered projection values; registers nothing model-facing.' },
  ...
  'packages/writing/documents': { kind: 'indirect', reason: 'The service interface delegates model rendering to dsh-tool-documents.' },
  'packages/writing/documents-local': { kind: 'indirect', reason: 'The local provider delegates model rendering to dsh-tool-documents.' },
  'packages/writing/tool-documents': { kind: 'indirect', reason: 'The package registers tool schemas and a guidance section; the generated tool catalog and system-prompt renderer own the model-visible text.' },
  'packages/writing/writing-mode': { kind: 'indirect', reason: 'The package registers one prompt section; the system-prompt renderer owns the assembled model-visible text.' },
  ...
  'packages/host/plugin-control': { kind: 'none', reason: 'Host-side Loader enablement control; registers nothing model-facing.' },
  ...
  'packages/llm/model-hub': { kind: 'none', reason: 'Route compilation configures providers and fallbacks; adapters own the model-visible request.' },
  ...
  'packages/session/usage-stats': { kind: 'none', reason: 'The usageStats unit folds already-logged usage reports into a client-facing read model and registers nothing model-facing.' },
