...
The [desktop runtime surface note](../../.agents/notes/proposed/architecture/2026-08-15-desktop-runtime-surface.md) owns the two-stage design; [the Stage A implementation note](../../.agents/notes/implemented/architecture/2026-08-15-desktop-sidecar-shell.md) owns what landed.
